##mvim7 = with pkgs; import ./vim/macvim-7.4.nix { inherit stdenv fetchFromGitHub ncurses gettext pkgconfig cscope python ruby tcl perl luajit darwin; }
...
stdenv.mkDerivation rec {
  ...
  src = fetchFromGitHub {
    owner = "macvim-dev";
    repo = "macvim";
    rev = "3ad944b0b76259659e7b1b7e3d4633205ad8b405";
